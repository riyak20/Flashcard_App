...
### App Description
Add custom animations and styles to a flashcard app.
...
### App Description
Allow users to save multiple flashcards when they exit and reopen the app.
...
### App Description
Enable users to create their own flashcard.
